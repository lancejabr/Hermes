...
//
//void HermesBlockSetVoicePatternVolume(const char *identifier, float level, float msec);
//
//
//typedef struct _HermesVoiceObject {
//} HermesVoiceObject;
//
//
//
